...
spark = (
    ...
    # WICHTIG: KEIN checkpointFileManagerClass hier setzen
    .config(
        "spark.jars.packages",
        "org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.1,org.postgresql:postgresql:42.7.3"
    )
    # Workaround für Windows: reine Java-Local-FS-Implementierung verwenden
...
q = (clean.writeStream.outputMode("append")
     ...
     .option("checkpointLocation", "file:///C:/Users/reite/tmp/chk_taxi_pipe")
     .start())
